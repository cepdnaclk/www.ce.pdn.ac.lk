      ...
      ((d.prototype.init = function () {
        ...
        (d.prototype.zoomSwipe = function () {
          ...
          (a.core.$slide.on("touchstart.lg", function (c) {
            if (a.core.$outer.hasClass("lg-zoomed")) {
              ...
              ((f =
                d.prop("offsetHeight") * d.attr("data-scale") > a.core.$outer.find(".lg").height()),
                (e =
                  d.prop("offsetWidth") * d.attr("data-scale") > a.core.$outer.find(".lg").width()),
                (e || f) &&
                  (c.preventDefault(),
                  (b = {
        ...
        (d.prototype.zoomDrag = function () {
          ...
          (b.core.$slide.on("mousedown.lg.zoom", function (d) {
            ...
            ((h =
              f.prop("offsetHeight") * f.attr("data-scale") > b.core.$outer.find(".lg").height()),
              (g =
                f.prop("offsetWidth") * f.attr("data-scale") > b.core.$outer.find(".lg").width()),
        ...
        (c.core.$el.on("onAfterSlide.lg.tm", function (a, b, d) {
          history.replaceState
            ? history.replaceState(
                null,
                null,
                window.location.pathname + "#lg=" + c.core.s.galleryId + "&slide=" + d
              )
